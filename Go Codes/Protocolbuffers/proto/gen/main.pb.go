...
const file_main_proto_rawDesc = "" +
	...
	"\x05email\x18\x02 \x01(\tR\x05email2b\n" +
	"\aGreeter\x123\n" +
	"\bSayHello\x12\x12.main.HelloRequest\x1a\x13.main.HelloResponse\x12\"\n" +
	"\x06Orders\x12\n" +
	".user.User\x1a\f.order.OrderB\x0fZ\r../gen;mainpbb\x06proto3"
...
var file_main_proto_depIdxs = []int32{
	...
	4, // 3: main.Greeter.Orders:output_type -> order.Order
