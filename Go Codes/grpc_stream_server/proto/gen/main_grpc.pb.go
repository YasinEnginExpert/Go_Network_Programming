...
func (c *calculatorClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponce, error) {
...
func (UnimplementedCalculatorServer) Add(context.Context, *AddRequest) (*AddResponce, error) {
